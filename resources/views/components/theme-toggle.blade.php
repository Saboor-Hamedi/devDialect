<div x-data="{
    ...
    <div x-show="customizerOpen" x-cloak x-transition:enter="transition-opacity ease-linear duration-300"
        x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100"
        x-transition:leave="transition-opacity ease-linear duration-300" x-transition:leave-start="opacity-100"
        x-transition:leave-end="opacity-0" @click="customizerOpen = false"
    ...
    <aside
        ...
        :class="customizerOpen ? 'translate-x-0' : 'translate-x-full'">
        ...
        <div class="absolute top-1/2 -left-10 -translate-y-1/2">
            <button @click="customizerOpen = !customizerOpen"
                ...
                <i class="fa-solid fa-gear text-xs transition-transform duration-700 group-hover:rotate-180"
                    :class="customizerOpen ? 'rotate-180' : 'rotate-0'"></i>
            </button>
        </div>
        ...
        <div class="flex-1 overflow-y-auto py-4 px-2 space-y-6">
            <!-- Theme Selection -->
            <div class="space-y-3">
                <span class="text-[9px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-tighter">Theme
                    Selection</span>
                <div class="space-y-1">
